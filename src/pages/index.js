...
const IndexPage = () => (
  <Layout>
    <SEO title="About Us" />
      ...
      <p>Read about our current campaign for Community Benefits Agreements in &nbsp;
        <a style={{color:"#10AC84"}} href="https://blockclubchicago.org/2020/03/06/weed-company-vows-to-hire-those-hurt-by-war-on-drugs-and-more-in-milestone-agreement-with-cannabis-equity-coalition/" target="_blank" rel="noreferrer noopener">
          Block Club Chicago
        </a> and in the&nbsp;
        <a style={{color:"#10AC84"}} href="https://chicago.suntimes.com/cannabis/2020/2/12/21135244/chicago-dispensaries-marijuana-cannabis-equity" target="_blank" rel="noreferrer noopener"> 
          Chicago Sun-Times
        </a>
        .
      </p>
